...
These instructions apply to the whole `Assignment 1` repository. They are meant to keep work understandable to the team and reproducible for the next person who opens the project.
...
Keep this file and [`CLAUDE.md`](CLAUDE.md) aligned when shared workflow rules change. Do not commit or push changes unless the user asks for it.
